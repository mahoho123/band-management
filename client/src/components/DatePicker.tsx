...
export function DatePicker({ year, month, yearOptions, onYearChange, onMonthChange }: DatePickerProps) {
  ...
  return (
    <div className="flex items-center gap-1 sm:gap-2 min-w-0 relative">
      ...
      {/* Year Picker Dropdown - Expanded Size */}
      {showYearPicker && (
        <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-2xl p-4 z-50 border border-gray-200 min-w-max">
      ...
      {/* Month Picker Dropdown - Expanded Size */}
      {showMonthPicker && (
        <div className="absolute top-full left-24 mt-1 bg-white rounded-lg shadow-2xl p-4 z-50 border border-gray-200 min-w-max">
